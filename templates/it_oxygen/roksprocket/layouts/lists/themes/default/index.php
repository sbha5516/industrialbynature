	...
	<div class="sprocket-lists-nav">
		<div class="sprocket-lists-pagination<?php echo !$parameters->get('lists_show_pagination') || $pages <= 1 ? '-hidden' : '';?>">
			...
			<?php for ($i = 1, $l = $pages;$i <= $pages;$i++): ?>
				...
				?>
		    	<li<?php echo $class; ?> data-lists-page="<?php echo $i; ?>"><i class="fa fa-circle"></i></li>
			<?php endfor; ?>
			</ul>
		</div>
		...
		<div class="sprocket-lists-arrows">
			<span class="arrow next" data-lists-next><i class="fa fa-chevron-right"></i></span>
			<span class="arrow prev" data-lists-previous><i class="fa fa-chevron-left"></i></span>
		</div>
		<?php endif; ?>
	</div>
</div>
